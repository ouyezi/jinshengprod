module.exports = {
  apps: [
    ...
    {
      name: 'jinsheng-frontend',
      cwd: '/Users/dongfuxlab/workspace/jinshengprod/web',
      script: 'npm',
      args: 'run dev -- --host',
      exec_mode: 'fork',
      instances: 1,
      ...
      log_file: '/Users/dongfuxlab/workspace/jinshengprod/logs/pm2-frontend.log',
      out_file: '/Users/dongfuxlab/workspace/jinshengprod/logs/pm2-frontend-out.log',
      error_file: '/Users/dongfuxlab/workspace/jinshengprod/logs/pm2-frontend-error.log',
      merge_logs: true,
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
    },
  ],
